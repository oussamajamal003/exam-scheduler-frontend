...
export function SplashScreen({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_top,_rgba(15,23,42,0.96),_rgba(15,23,42,0.82)_40%,_rgba(30,41,59,0.96)_100%)] text-white">
      ...
      <div className="relative flex flex-col items-center gap-6 px-6 text-center">
        ...
        <div className="h-1.5 w-56 overflow-hidden rounded-full bg-white/10">
          <div className="h-full w-1/2 rounded-full bg-gradient-to-r from-cyan-300 via-white to-cyan-300 animate-[loading-bar_1.6s_ease-in-out_infinite]" />
        </div>
      </div>
    </div>
  );
